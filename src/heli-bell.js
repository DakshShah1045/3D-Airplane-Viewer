...
mtlLoader.load('/3D-Airplane-Viewer/Heli_Bell/Material/Heli.mtl', function (materials) {
    console.log("✅ MTL file loaded successfully!");
    materials.preload();
    const objLoader = new OBJLoader();
    objLoader.setMaterials(materials);
objLoader.load('/3D-Airplane-Viewer/Heli_Bell/Material/heli.obj', function (object) {
        console.log(object)
