...
mtlLoader.load('/3D-Airplane-Viewer/static/helecopter/chopper.mtl', function (materials) {
    console.log("✅ MTL file loaded successfully!");
    materials.preload();
    const objLoader = new OBJLoader();
    objLoader.setMaterials(materials);
    objLoader.load('/3D-Airplane-Viewer/static/helecopter/heli.obj', function (object) {
        console.log(object)
